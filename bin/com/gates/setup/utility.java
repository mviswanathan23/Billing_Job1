...
public class utility {
	...
	public WebElement getelement_cssPath(String key)
	{
		...
		//return driver.findElement(By.cssSelector(ui.getProperty(key)));
	}
	public WebElement getelement_cssPath2(String key) throws InterruptedException
	{
	//	return driver.findElement(By.cssSelector(key));		
		return driver.findElement(By.cssSelector(ui.getProperty(key)));
	}
	...
	public String verifyErrorAlertPresent(String alertmsg) {
		...
		try {
			...
			String msg=alertElement.getText();
...
public void selectmultiblecheckbox(String tableid,int dividval,int rowcount) throws InterruptedException {
	...
	public WebElement clickFirstLink2(String table_ID, String row, String col) throws InterruptedException {
		/*scrolltoElement_xpath("//*[@id='" + table_ID + "']//tr[" + row + "]/td[" + col + "]/a");
		return new WebDriverWait(driver, 25).until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//*[@id='" + table_ID + "']//tr[" + row
				+ "]/td[" + col + "]/a"))));*/
		if(row!=""){
			  scrolltoElement_xpath("//*[@id='" + table_ID + "']//tr[" + row + "]/td[" + col + "]/pre/a");
			  return new WebDriverWait(driver, 25).until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//*[@id='" + table_ID + "']//tr[" + row
			    + "]/td[" + col + "]/pre/a"))));
			}
			else{
			...
			scrolltoElement_xpath("//*[@id='" + table_ID + "']//tr[" + row + "]/td[" + col + "]/pre/a");
			  return new WebDriverWait(driver, 25).until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//*[@id='" + table_ID + "']//tr/td[" + col + "]/pre/a"))));
	...
	public void clearvalue2(String key) throws InterruptedException {
		try {
			getUiElement_id(key).clear();
	...
	public void sendtab2(String objectname) throws InterruptedException
	{
		try
		{
			WebDriverWait wait = new WebDriverWait(driver, 60);
